/* ===========================================================================
 * Ariadne Threadworks — Web ページ資料の既定スクリプト（固定）
 *
 * スライドのスクロール追従（左の目次のハイライト）・カウンタ更新・
 * キーボード操作（矢印/PageUp・Down/Home/End）・印刷ボタンを担う。
 * **書き換えない。** HTML 側の構造（.slide / .toc__link / #slide-counter /
 * [data-action]）に依存する。SKELETON.html の構造をそのまま使うこと。
 * =========================================================================== */
